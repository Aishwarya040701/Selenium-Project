...
public class Demo {
		...
		public static void main(String[] args) {
			...
			WebElement elc1 = driver.findElement(By.xpath("//li[@class='sfHover']//a[@title='Dresses'][contains(text(),'Dresses']"));
			...
			driver.findElement(By.id("email_create")).sendKeys("HM040701Aishu12345aaaaaaaaaaaaa@gmail.com");
			...
			driver.findElement(By.cssSelector("input#customer_firstname")).sendKeys("Aishuaaaaaaaaaaa");
            driver.findElement(By.cssSelector("input#customer_lastname")).sendKeys("HMLaaaaaaaaaaa");
			driver.findElement(By.cssSelector("input#passwd")).sendKeys("aishu12345aaaaaaaaaaaa");
			...
			//finding web element by cssSelector locator--->DropDown
			// new Select(driver.findElement(By.xpath("//select[@id='id_country']"))).selectByVisibleText("-");
